...
const Footer = () => {
    return (
        <footer className="w-100 py-5 bg-background landing-footer" style={{ borderTop: '1px solid rgba(74, 101, 79, 0.1)' }}>
            <div className="container-xl px-4">
                <div className="row g-5">
                    ...
                    <div className="col-12 col-md-4">
                        ...
                        <div className="d-flex gap-3 mt-4">
                            <a href="#" className="btn btn-outline-primary rounded-circle d-flex align-items-center justify-content-center p-0 text-primary footer-social-icon" style={{ width: '40px', height: '40px' }} aria-label="Facebook">
                            ...
                            <a href="#" className="btn btn-outline-primary rounded-circle d-flex align-items-center justify-content-center p-0 text-primary footer-social-icon" style={{ width: '40px', height: '40px' }} aria-label="Instagram">
                            ...
                            <a href="#" className="btn btn-outline-primary rounded-circle d-flex align-items-center justify-content-center p-0 text-primary footer-social-icon" style={{ width: '40px', height: '40px' }} aria-label="TikTok">
                            ...
                            <a href="#" className="btn btn-outline-primary rounded-circle d-flex align-items-center justify-content-center p-0 text-primary footer-social-icon" style={{ width: '40px', height: '40px' }} aria-label="X (Twitter)">
                ...
                <div className="text-center mt-5 pt-4" style={{ borderTop: '1px solid rgba(174, 180, 170, 0.2)' }}>
                    <p className="text-secondary text-uppercase tracking-widest m-0" style={{ fontSize: '0.75rem' }}>
                        © 2026 AdoptApp. Encuentra a tu mejor amigo.
                    </p>
                </div>
            </div>
        </footer>

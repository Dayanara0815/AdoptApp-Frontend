...
const petsData = [
  {
    ...
    name: 'Whiskers',
    age: '2 Years',
    description: 'A calm and gentle companion who loves quiet afternoons and chasing sunbeams across the rug.',
  ...
  },
  {
    ...
    name: 'Luna',
    age: '5 Months',
    description: 'High energy pup looking for an active family who loves morning runs and weekend hikes.',
  ...
  },
  {
    ...
    name: 'Barnaby',
    age: '8 Years',
    description: 'A senior gentleman who enjoys short walks and long naps. Perfectly house-trained and great with kids.',
    breed: 'Beagle Mix',
    trait: 'Senior',
  ...
  },
  {
    ...
    name: 'Oliver',
    age: '1 Year',
    description: 'A small dog with a huge personality. Will follow you everywhere and demand all the head scratches.',
    breed: 'Pug',
    trait: 'Small',
  ...
  },
  {
    ...
    name: 'Misty',
    age: '3 Years',
    description: 'Reserved but deeply affectionate once she trusts you. Looking for a peaceful home environment.',
    breed: 'Russian Blue',
    trait: 'Calm',
  ...
  },
  {
    ...
    name: 'Felix',
    age: '4 Years',
    description: 'Master hunter of toy mice and lover of high places. Felix needs vertical space to thrive.',
    breed: 'Tuxedo Cat',
    trait: 'Playful',
